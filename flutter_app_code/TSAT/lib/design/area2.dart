...
import 'package:myapp/design/stat2.dart';

class Area2Page extends StatelessWidget {
  const Area2Page({Key? key}) : super(key: key);
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            ClipOval(
              child: Image.asset(
                'assets/design/images/tomato1.png',
                width: 120.0,
                height: 120.0,
                fit: BoxFit.cover,
              ),
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const Stat2Page()),
                    );
                  },
